...
// Archival founder/role records - see the comment in ../archive/page.tsx.
const trusteesData = {
    founders: [
...
export default function TrusteesHistory() {
    const t = useTranslations('donations.trusteesHistory');
    const handlePrint = () => {
        window.print();
    };
                    ...
                    <div className="space-y-12">
                        ...
                        <section className="text-center">
                            <div className="inline-block border-2 border-gray-800 px-8 py-1 mb-6">
                                <h2 className="text-xl font-bold">{t('founderHeading')}</h2>
                            </div>
