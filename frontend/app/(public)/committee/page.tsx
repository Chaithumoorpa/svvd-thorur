...
export const metadata: Metadata = {
  ...
  description: 'The trustees and office bearers who serve the temple.',
};
...
export default async function CommitteePage() {
  ...
  return (
    <PageShell title="Temple Committee" subtitle="The trustees and office bearers who serve the temple">
      {members.length ? (
        ...
        <div className="rounded-2xl border border-dashed border-amber-300 bg-white p-12 text-center">
          ...
          <p className="text-gray-500">The committee will be listed here soon.</p>
        </div>
      )}
    </PageShell>
  );
