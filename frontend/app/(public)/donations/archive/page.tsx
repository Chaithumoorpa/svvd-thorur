        ...
        <PageContainer>
            <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 bg-white print:p-0">
                ...
                <div className="flex justify-between items-center mb-6 print:hidden">
                    <h1 className="text-2xl font-serif font-bold text-gray-900">Historical Donation Records</h1>
                    <button
                        onClick={handlePrint}
                ...
                <div className="border-4 border-double border-gray-800 p-4 sm:p-8 font-serif bg-white text-gray-900">
                        ...
                        <table className="w-full border-collapse">
                            <thead>
                                <tr className="border-b-2 border-gray-800">
                                    <th className="text-left py-3 px-2 font-bold w-12">క్ర. సం.</th>
                                    <th className="text-left py-3 px-2 font-bold">విరాళదారుని పేరు & వివరాలు (Donor Name & Details)</th>
                                    <th className="text-right py-3 px-2 font-bold w-40">మొత్తం (Amount)</th>
                                </tr>
                            </thead>
                            <tbody>
                                {archiveData.map((item, index) => (
                                    <tr key={index} className="border-b border-gray-300">
                                        ...
                                        <td className="py-2 px-2 text-right font-semibold text-gray-900">రూ. {item.amount}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-400 text-center italic text-sm text-gray-600">
                        <p>"ఈ విరాళాల వివరాలు పాత రికార్డుల నుండి తీసుకోబడ్డవి. ఇవి మార్పులకు లోబడవు."</p>
                        <p className="mt-4">"ఈ పేజీలో ఉన్న సమాచారం చారిత్రక రికార్డుల ఆధారంగా పొందుపరచబడింది. ఇది సమాచార ప్రయోజనాల కొరకు మాత్రమే."</p>
                    </div>
                </div>
            </div>
