        ...
        <PageContainer>
            <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 bg-white print:p-0">
                <div className="flex justify-between items-center mb-6 print:hidden">
                    <h1 className="text-2xl font-serif font-bold text-gray-900">Archived Donors (Land & items)</h1>
                    <button
                        onClick={handlePrint}
                    ...
                    <div className="space-y-12">
                        ...
                        <section>
                            <div className="inline-block border-2 border-gray-800 px-6 py-1 mb-6">
                                <h2 className="text-xl font-bold">స్థల దాతలు (Land Donors)</h2>
                            </div>
                        ...
                        <section>
                            <div className="inline-block border-2 border-gray-800 px-6 py-1 mb-6">
                                <h2 className="text-xl font-bold">వస్తు రూపేణా యిచ్చిన దాతలు (Item Donors)</h2>
                            </div>
                                ...
                                <table className="w-full border-collapse">
                                    <thead>
                                        <tr className="border-b-2 border-gray-800">
                                            ...
                                            <th className="text-right py-3 px-2 font-bold w-48">వస్తువు వివరాలు (Item Details)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
